...
// Only run this if we're on tournament.html
if (window.location.pathname.startsWith("tournament.html")) {
    /* SUBMIT TEAM */
...
// Only run this if we're on tournament.html
if (window.location.pathname.includes("oldtournament.html")) {

    const params = new URLSearchParams(window.location.search);
    const date = "feb" + params.get("date");

    if (!date) {
        console.log("No tournament date provided");
    } else {

        console.log(date)
        const teamsCol = collection(db, "tournaments", date, "teams");
